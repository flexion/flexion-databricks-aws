...
# Trust relationship: Databricks-owned AWS account assumes this role
# scoped to the Flexion Databricks account ID.
...
# This is the standard Databricks cross-account policy. Reference:
